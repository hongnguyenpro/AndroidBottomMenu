...
public class BottomMenuItem extends LinearLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.BottomBarItemStyle);
        String text = ta.getString(R.styleable.BottomBarItemStyle_title);

        normalImage = ta.getDrawable(R.styleable.BottomBarItemStyle_normalImage);
        selectedImage = ta.getDrawable(R.styleable.BottomBarItemStyle_selectedImage);

        normalTitleColor = ta.getColor(R.styleable.BottomBarItemStyle_normalTitleColor,
                Color.parseColor("#444444")); // default color is gray
        selectedTitleColor = ta.getColor(R.styleable.BottomBarItemStyle_selectedTitleColor,
